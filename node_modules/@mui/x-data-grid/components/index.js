...
var _GridNoColumnsOverlay = require("./GridNoColumnsOverlay");
Object.keys(_GridNoColumnsOverlay).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _GridNoColumnsOverlay[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _GridNoColumnsOverlay[key];
    }
  });
});
