...
const skSKGrid = {
  ...
  toolbarPromptControlErrorMessage: 'Pri spracovaní požiadavky došlo k chybe. Skúste to znova s inou požiadavkou.',
  ...
  paginationDisplayedRows: ({
    ...
    const estimatedLabel = estimated && estimated > to ? `približne ${estimated}` : `viac ako ${to}`;
